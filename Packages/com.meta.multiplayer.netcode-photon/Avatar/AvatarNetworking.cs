...
namespace Meta.Multiplayer.Avatar
{
    ...
    public class AvatarNetworking : NetworkBehaviour
    {
        ...
        private void SendAvatarData_ServerRpc(byte[] data, ServerRpcParams args = default)
        {
            ...
            var targetClients = allClients.Except(args.Receive.SenderClientId).ToList();
            SendAvatarData_ClientRpc(data, new ClientRpcParams { Send = new ClientRpcSendParams { TargetClientIds = targetClients } });
        }
