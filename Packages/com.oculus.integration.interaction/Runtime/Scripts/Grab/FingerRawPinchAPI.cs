...
namespace Oculus.Interaction.GrabAPI
{
    ...
    public class FingerRawPinchAPI : IFingerAPI
    {
        ...
        {
            // In order to work around issue when switching between controllers and hands, always return true here
            return true;// _fingersPinchData[(int)finger].IsPinchingChanged &&
