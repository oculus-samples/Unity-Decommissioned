...
namespace Meta.Utilities.Input
{
    ...
    public class FromXRHandDataSource : DataSource<HandDataAsset>
    {
        ...
        private MonoBehaviour m_hmdData;
        private IDataSource<HmdDataAsset> HmdData { get; set; }
        ...
        protected void Awake()
        {
            ...
            HmdData = m_hmdData as IDataSource<HmdDataAsset>;
        ...
        {
            m_hmdData = hmdData as MonoBehaviour;
            HmdData = hmdData;
        }
